...
== Current State
At present, I would say that SimpleVM is in the 1.1 version range as all the
...
featured as well, with the OPCODE language featuring FORK and JOIN words.
...
for the instruction number cursor.
    ...
    -------------+-----------+-----------+------------------------------------------
        ...
        FORK     | 2163906   | N1        | creates a new cursor at line N1
        ...
        JOIN     | 2282794   |           | kills current cursor
