= Simple VM
Simple VM is just what it claims to be, a simple virtual machinein pure ANSI C
...
and conditional branching. As of 1.5, SimpleVM also features threading.

== Current State
At present, I would say that SimpleVM is in the 1.6 version range as all the
...
== ToDone List
 * Case-insensitivity
 * Threading through FORK and JOIN words, exit on 0 running threads
 * RISC archetecture
